...
const Sidebar = () => (
  <section id="sidebar">
    ...
    <a className="link side-link" href="https://drive.google.com/file/d/1sRA9jXoVK0A6WKuuC_eq3uW7V2-WB9q9/view?usp=sharing" title="My Resume" target="_blank"><img className="icon" src="https://live.staticflickr.com/65535/48689825136_95a132994e_m.jpg" alt="resume-icon"/></a>
