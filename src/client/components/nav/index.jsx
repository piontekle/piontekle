...
const Sidebar = () => (
  <section id="sidebar">
    ...
    <a className="link" href="https://twitter.com/DevByLP" title="My Dev Twitter" target="_blank"><img className="icon twitter" src="https://live.staticflickr.com/65535/48692857941_87618f3f01_m.jpg"  alt="twitter-icon"/></a>
  </section>
)
